...
import jobtrends.job_aymax.databinding.ListviewQuestionViewBinding
import jobtrends.job_aymax.model.Answer
...
class AnswerViewModel(var list : List<Answer>) : BaseAdapter()
{
	...
	override fun getView(position : Int, convertView : View?, parent : ViewGroup?) : View
	{
		...
		val binding : ListviewQuestionViewBinding = DataBindingUtil.inflate(inflater, R.layout.listview_question_view, parent, false)
		binding.vm = this
